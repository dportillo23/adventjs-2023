...
Find the first identification number that has been repeated, <strong style="color: #faca15">where the second occurrence has the smallest index</strong>!
...
```
<strong style="color: #faca15">Watch out!</strong> The elves say this is a Google technical test.
